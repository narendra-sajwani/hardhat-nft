...
contract DynamicSvgNft is ERC721 {
    ...
    function mintNft(int256 highValue) public {
        ...
        emit MintedNFT(newTokenId, highValue);
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        // string memory imageURI = "dummy";

        // data:image/svg+xml;base64, prefix for base64 encoded svg images
        // data:application/json;base64, prefix for base64 encoded json
